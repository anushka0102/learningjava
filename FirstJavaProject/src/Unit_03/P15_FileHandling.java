...
class ABCDE{
	...
	void takeInputFromAFileNotFromConsole() throws IOException {
		String path="C:\\Users\\DELL\\git\\learningjava\\FirstJavaProject\\src\\Unit_03\\input.txt";
...
void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DELL\\git\\learningjava\\FirstJavaProject\\src\\Unit_03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
